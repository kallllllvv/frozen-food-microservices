...
export default function AdminDashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] flex font-sans text-gray-900 selection:bg-indigo-500 selection:text-white relative overflow-hidden">
            ...
            {/* SIDEBAR */}
            <aside className="w-64 bg-gradient-to-b from-[#0F172A] via-[#1e1b4b] to-[#0F172A] text-white flex-col hidden lg:flex fixed inset-y-0 z-50 shadow-2xl border-r border-indigo-500/10">
            ...
            <div className="flex-1 flex flex-col min-w-0 lg:ml-64 relative z-10">
                ...
                <header className="h-16 bg-white/70 backdrop-blur-md border-b border-slate-200/60 flex items-center justify-between px-6 sticky top-0 z-40 shadow-sm">
                    <div className="flex items-center bg-slate-100/80 rounded-xl px-4 py-2 w-72 border border-slate-200 focus-within:border-indigo-400 focus-within:bg-white focus-within:shadow-md focus-within:shadow-indigo-500/5 transition-all duration-300">
